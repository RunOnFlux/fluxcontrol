...
async function getFluxVersion(ip) {
  try {
    ...
    if (loginPhraseResponse.data.status === 'success') {
      return Number(loginPhraseResponse.data.data.split('.')[0]);
    } else {
      throw loginPhraseResponse.data.data;
    }
  } catch (error) {
...
async function massLogin() {
  const ipsObtained = [
    '62.171.132.142',  '188.239.61.176',
    '188.239.61.165',  '188.239.61.47',
    '188.239.61.38',   '62.171.174.176',
    '188.239.61.200',  '207.180.253.144',
    '167.86.72.143',   '67.205.159.237',
    '62.171.172.60',   '188.239.61.215',
    '193.188.15.224',  '193.188.15.233',
    '24.120.133.162',  '188.239.61.97',
    '188.239.61.87',   '188.239.61.210',
    '62.171.174.157',  '62.171.176.42',
    '164.68.101.236',  '167.86.92.216',
    '62.171.185.51',   '144.91.97.7',
    '173.212.202.225', '173.249.34.234',
    '213.231.3.224',   '77.37.224.231',
    '193.188.15.225',  '193.188.15.217',
    '193.38.33.231',   '193.38.34.82',
    '193.38.34.86'
  ]
